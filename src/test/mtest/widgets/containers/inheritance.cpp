...
MTEST_BEGIN("tk.widgets.containers", inheritance)
...
//        box->bg_color()->set_rgb(1.0, 1.0, 1.0);
        ...
        grid->columns()->set(2);
        {
            ...
            MTEST_ASSERT(init_widget(wv, vh, "void1") == STATUS_OK);
            MTEST_ASSERT(widgets.push(wv));
            MTEST_ASSERT(grid->add(wv) == STATUS_OK);
            wv->padding()->set(4);
            wv->constraints()->set(32, 32, 48, 48);
            wv->bg_color()->set_rgb24(next_color(col));
            wv->color()->set_rgb24(next_color(col));
            wv->pointer()->set(ws::MP_HAND);
            wv->bg_inherit()->set(true);

            // Create widget (2)
            MTEST_ASSERT(wv = new tk::Void(dpy));
            MTEST_ASSERT(init_widget(wv, vh, "void2") == STATUS_OK);
            MTEST_ASSERT(widgets.push(wv));
            MTEST_ASSERT(grid->add(wv) == STATUS_OK);
            wv->padding()->set(4);
            wv->constraints()->set(32, 32, 48, 48);
            ...
            wv->color()->set_rgb24(next_color(col));
            wv->pointer()->set(ws::MP_HAND);
            wv->bg_inherit()->set(false);

            // Create box
            MTEST_ASSERT(box = new tk::Box(dpy));
            MTEST_ASSERT(init_widget(box, vh, "box1") == STATUS_OK);
            MTEST_ASSERT(widgets.push(box));
            MTEST_ASSERT(grid->add(box) == STATUS_OK);
...

            {
                ...
                MTEST_ASSERT(init_widget(kn, vh, "knob1") == STATUS_OK);
                MTEST_ASSERT(widgets.push(kn));
                MTEST_ASSERT(box->add(kn) == STATUS_OK);
                kn->bg_color()->set_rgb24(next_color(col));
                kn->bg_inherit()->set(true);

                MTEST_ASSERT(kn = new tk::Knob(dpy));
                MTEST_ASSERT(init_widget(kn, vh, "knob2") == STATUS_OK);
                MTEST_ASSERT(widgets.push(kn));
                MTEST_ASSERT(box->add(kn) == STATUS_OK);
                kn->bg_color()->set_rgb24(next_color(col));
                kn->bg_inherit()->set(true);
                ...
                MTEST_ASSERT(kn = new tk::Knob(dpy));
                MTEST_ASSERT(init_widget(kn, vh, "knob3") == STATUS_OK);
                MTEST_ASSERT(widgets.push(kn));
                MTEST_ASSERT(box->add(kn) == STATUS_OK);
                kn->bg_color()->set_rgb24(next_color(col));
                kn->bg_inherit()->set(false);
            }

            // Create box
            MTEST_ASSERT(box = new tk::Box(dpy));
            MTEST_ASSERT(init_widget(box, vh, "box2") == STATUS_OK);
            MTEST_ASSERT(widgets.push(box));
            MTEST_ASSERT(grid->add(box) == STATUS_OK);
            ...
            {
                MTEST_ASSERT(kn = new tk::Knob(dpy));
                MTEST_ASSERT(init_widget(kn, vh, "knob4") == STATUS_OK);
                MTEST_ASSERT(widgets.push(kn));
                MTEST_ASSERT(box->add(kn) == STATUS_OK);
                kn->bg_color()->set_rgb24(next_color(col));
                kn->bg_inherit()->set(true);
                ...
                MTEST_ASSERT(kn = new tk::Knob(dpy));
                MTEST_ASSERT(init_widget(kn, vh, "knob5") == STATUS_OK);
                MTEST_ASSERT(widgets.push(kn));
                MTEST_ASSERT(box->add(kn) == STATUS_OK);
                kn->bg_color()->set_rgb24(next_color(col));
                kn->bg_inherit()->set(true);
                ...
                MTEST_ASSERT(kn = new tk::Knob(dpy));
                MTEST_ASSERT(init_widget(kn, vh, "knob6") == STATUS_OK);
                MTEST_ASSERT(widgets.push(kn));
                MTEST_ASSERT(box->add(kn) == STATUS_OK);
                kn->bg_color()->set_rgb24(next_color(col));
                kn->bg_inherit()->set(false);
