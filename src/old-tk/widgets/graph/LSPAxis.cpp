...
#include <lsp-plug.in/tk-old/helpers/graphics.h>
#include <lsp-plug.in/tk-old/widgets/graph/LSPAxis.h>

#define AMPLIFICATION_THRESH        1e-8
...
namespace lsp
{
    namespace tk
    {
        ...
        void LSPAxis::render(ws::ISurface *s, bool force)
        {
            // Get graph
            LSPGraph *cv = graph();
            if (cv == NULL)
