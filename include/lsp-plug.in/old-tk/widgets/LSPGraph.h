    ...
    namespace tk
    {
        ...
        class LSPGraph: public LSPWidgetContainer
        {
            ...
            protected:
                ...
                LSPColor                    sColor;
                lltl::parray<LSPGraphItem>  vObjects;
                lltl::parray<LSPAxis>       vAxises;
                lltl::parray<LSPAxis>       vBasises;
            ...
            protected:
                ws::ISurface           *get_canvas(ws::ISurface *s, ssize_t w, ssize_t h, const Color &color);
                void                    do_destroy();
