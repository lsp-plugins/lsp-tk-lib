    ...
    namespace tk
    {
        ...
        class LSPFileDialog: public LSPWindow
        {
            ...
            protected:
                ...
                status_t            add_menu_item(LSPMenu *m, const char *text, event_handler_t handler);
            ...
            public:
                ...
                inline status_t    bind_action(event_handler_t handler, void *arg = NULL) { return sAction.bind(handler, arg); };
                inline status_t    bind_cancel(event_handler_t handler, void *arg = NULL) { return sCancel.bind(handler, arg); };
