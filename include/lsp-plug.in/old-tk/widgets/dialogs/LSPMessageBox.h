    ...
    namespace tk
    {
        class LSPMessageBox: public LSPWindow
        {
            ...
            public:
                ...
                status_t    add_button(const char *text, event_handler_t handler = NULL, void *arg = NULL);
                status_t    add_button(const LSPString *text, event_handler_t handler = NULL, void *arg = NULL);
                status_t    add_button(const LSPLocalString *text, event_handler_t handler = NULL, void *arg = NULL);
